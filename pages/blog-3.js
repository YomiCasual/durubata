                        ...
                        <div className="col-lg-3 col-md-6">
                            <div className="single-blog-post">
                                ...
                                <div className="content">
                                    <h3>
                                        <Link href="/single-blog-1">
                                            <a>Digital Marketing for Lead Generation</a>
                                        </Link>
                                    </h3>
                                    <div className="d-flex align-items-center">
                        ...
                        <div className="col-lg-3 col-md-6">
                            <div className="single-blog-post">
                                ...
                                <div className="content">
                                    <h3>
                                        <Link href="/single-blog-1">
                                            <a>Preparing E-Commerce for the Post-COVID</a>
                                        </Link>
                                    </h3>
                                    <div className="d-flex align-items-center">
                                        <img src="/images/user2.jpg" alt="image" />
                        ...
                        <div className="col-lg-3 col-md-6">
                            <div className="single-blog-post">
                                ...
                                <div className="content">
                                    <h3>
                                        <Link href="/single-blog-1">
                                            <a>Should You Test That? When to Engage in SEO</a>
                                        </Link>
                                    </h3>
                                    <div className="d-flex align-items-center">
                                        <img src="/images/user3.jpg" alt="image" />
                        ...
                        <div className="col-lg-3 col-md-6">
                            <div className="single-blog-post">
                                ...
                                <div className="content">
                                    <h3>
                                        <Link href="/single-blog-1">
                                            <a>Understanding & Fulfilling Search Intent</a>
                                        </Link>
                                    </h3>
                                    <div className="d-flex align-items-center">
                                        <img src="/images/user2.jpg" alt="image" />
                        ...
                        <div className="col-lg-3 col-md-6">
                            <div className="single-blog-post">
                                ...
                                <div className="content">
                                    <h3>
                                        <Link href="/single-blog-1">
                                            <a>How to Network Online Like a Champ</a>
                                        </Link>
                                    </h3>
                                    <div className="d-flex align-items-center">
                                        <img src="/images/user1.jpg" alt="image" />
