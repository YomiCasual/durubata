            ...
            <div className="team-area ptb-100">
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-6">
                            <div className="single-team-box">
                                <img src="/images/team/team-img7.jpg" alt="team-image" />
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-6">
                            <div className="single-team-box">
                                <img src="/images/team/team-img8.jpg" alt="team-image" />
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-6">
                            <div className="single-team-box">
                                <img src="/images/team/team-img9.jpg" alt="team-image" />
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-6">
                            <div className="single-team-box">
                                <img src="/images/team/team-img10.jpg" alt="team-image" />
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-6">
                            <div className="single-team-box">
                                <img src="/images/team/team-img11.jpg" alt="team-image" />
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-6">
                            <div className="single-team-box">
                                <img src="/images/team/team-img12.jpg" alt="team-image" />
