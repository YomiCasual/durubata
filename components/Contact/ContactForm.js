...
const ContactForm = () => {
    ...
    return (
        <div className="contact-area pb-100 pt-70">
            <div className="container">
                <div className="section-title">
                    <span className="sub-title">Get in Touch</span>
                    <h2>Ready to Get Started?<span className="overlay"></span></h2>
                    <p>We are always eager to hear what you had on your mind, it might just be the next idea that would change the world.</p>
                </div>
